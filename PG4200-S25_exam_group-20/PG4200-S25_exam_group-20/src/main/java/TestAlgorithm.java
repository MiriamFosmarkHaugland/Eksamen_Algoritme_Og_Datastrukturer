...
//        runJVMWarmUp(dataset, 10, false, "Bubble Sort (non-optimised)", task_1_bubblesort_nonoptimised::bubbleSort);
//        runJVMWarmUp(dataset, 10, false, "Bubble Sort (optimised)", task_1_bubblesort_optimised::bubbleSort);
        runJVMWarmUp(dataset, 10, false, "Insertion Sort", task_2_insertionsort::insertionSort);
        runJVMWarmUp(dataset, 10, false, "Insertion Sort", task_2_insertionsort::binaryInsertionSort);
//        runJVMWarmUp(dataset, 10, false, "Merge Sort", task_3_mergesort::mergeSort);
//        runJVMWarmUpQuickSort(dataset, 100, false, "Quick Sort: First element pivot", task_4_1_quicksort::quickSort);
//        runJVMWarmUpQuickSort(dataset, 100, false, "Quick Sort: Last element pivot", task_4_2_quicksort::quickSort);
//        runJVMWarmUpQuickSort(dataset, 100, false, "Quick Sort: Random element pivot", task_4_3_quicksort::quickSort);

        // Runs the algorithm with and without shuffelling of the data set
//        testAlgorithm(dataset, true, 100, "Bubble Sort (non-optimised)", task_1_bubblesort_nonoptimised::bubbleSort);
//        testAlgorithm(dataset, true, 100, "Bubble Sort (optimised)", task_1_bubblesort_optimised::bubbleSort);
        testAlgorithm(dataset, true, 100, "Insertion Sort", task_2_insertionsort::insertionSort);
        testAlgorithm(dataset, true, 100, "Binary Insertion Sort", task_2_insertionsort::binaryInsertionSort);
//        testAlgorithm(dataset, true, 100, "Merge Sort", task_3_mergesort::mergeSort);
//        testQuickSort(dataset, true, 100, "Quick Sort: First element pivot", task_4_1_quicksort::quickSort);
//        testQuickSort(dataset, true, 100, "Quick Sort: Last element pivot", task_4_2_quicksort::quickSort);
//        testQuickSort(dataset, true, 100, "Quick Sort: Random element pivot", task_4_3_quicksort::quickSort);
//        testQuickSort(dataset, true, 100, task_4_1_quicksort::quicksort);
     ...
     */
    public static void runJVMWarmUpQuickSort(ArrayList<City> dataset, int warmUpLength, boolean print, String name,
     ...
     * @param algorithm Algoritmen som skal testes, gitt som lambda med 3 parameter
     */
    private static void testQuickSort(ArrayList<City> dataset, boolean shuffle, int repetitions,
                                      String name, QuickSortMethod<ArrayList<City>, Integer, Integer> algorithm) {
        System.out.printf("\n*** Starting test of %s ***\n", name);
        Timer timer = new Timer();
        long totalTime = 0;
