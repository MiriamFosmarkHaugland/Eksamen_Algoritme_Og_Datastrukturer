...
public class task_4_3_quicksort {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Number of comparisons to sort the dataset, when pivot is a random element: " + comparisonCount);
    }
    ...
    /* Quick Sort with pivot being a random element */
    ...
    public static int partition(ArrayList<City> array, int low, int high) {
        // Chooses a random element in current segment as the pivot element
